...
@Component({
  ...
  templateUrl: './service-sales.page.html',
  styleUrls: ['./service-sales.page.scss'],
})
export class ServiceSalesPage extends RouterPage{
...
//         this.invoiceService.getAllServiceSalesReport(filterStr).subscribe((res) => {
//           this.reportList = [];
//           if(res?.data?.result) {
